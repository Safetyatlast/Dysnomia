...
class Handler {
   ...
   * @returns {Promise<{MissingPermissions: (Eris.Guild|boolean), Error: symbol}|{Precondition: Precondition, Error: symbol}|{Argument: Argument, ErrorMessage: String, Error: symbol}|{Exception: Error, Error: symbol}|{Error: symbol}>}
   */
  async run(msg) {
