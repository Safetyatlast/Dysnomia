...
class Argument {
  ...
  constructor(options) {
    ...
    if (typeof options.typeReader === 'string' && options.typeReader !== "") this.typeReaders = [options.typeReader];
    else if (Array.isArray(options.typeReader) && options.typeReader.length > 0) this.typeReaders = options.typeReader;
